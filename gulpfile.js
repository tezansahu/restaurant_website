...
gulp.task('style', gulp.series(gulp.parallel(['css-main', 'css-vendor', 'copy-fonts']), done =>{
    done()
}))
gulp.task('js', gulp.series(gulp.parallel(['js-main', 'js-vendor']), done =>{
    done()
}))
gulp.task('prod', gulp.series(gulp.parallel(['style', 'js']), done =>{
    done()
}) )
